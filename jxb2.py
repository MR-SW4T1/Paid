...
def uaku():
	try:
		...
		a=requests.get('https://github.com/MR-SW4T1/Paid/blob/main/M.txt').text
		ua=open('.bbnew.txt','w')
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/MR-SW4T1/Paid/blob/main/M.txt').text
...
==================================================   """)
  ...
  try:
    httpCaht = requests.get("https://github.com/MR-SW4T1/Paid/blob/main/M.txt").text
    if id in httpCaht:
